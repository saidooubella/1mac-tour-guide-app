...
import com.said.oubella.so.essaouiratour.adapters.HotelsAdapter;
...
public final class HotelsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Helper.initAndSetAdapter(binding.recyclerView, new HotelsAdapter(dataSource.getHotelsList(), new HotelsAdapter.ItemClickListener() {
