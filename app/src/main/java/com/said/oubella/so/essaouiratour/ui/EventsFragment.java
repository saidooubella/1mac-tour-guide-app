...
import com.said.oubella.so.essaouiratour.adapters.EventsAdapter;
...
public final class EventsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Helper.initAndSetAdapter(binding.recyclerView, new EventsAdapter(dataSource.getEventsList()));
    }
}
